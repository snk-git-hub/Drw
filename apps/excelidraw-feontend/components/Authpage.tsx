...
return  <div className="w-screen h-screen flex justify-center items-center bg-black relative overflow-hidden">
      ...
      <div className="relative p-10 m-4 bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-zinc-800/50 w-full max-w-md">
        ...
        <div className="mt-8 text-center">
          <p className="text-zinc-500 text-xs font-light">
            ...
            <span className="text-white hover:text-zinc-300 cursor-pointer ml-2 font-normal">
